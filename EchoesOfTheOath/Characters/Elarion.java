...
public class Elarion extends Character {
    ...
    public Elarion() {
        super("Elarion", " DEMON REALM < NATION 3 > - MAIN BOSS", 1400, 8);
    ...
    public Sprite[] getSkillSprite(int skillNumber) {
        switch (skillNumber) {
            case 1 -> bgm.playSFX("ELARION -- Echo Rend.wav");
            case 2 -> bgm.playSFX("ELARION --Memory Shatter.wav");
            case 3 -> bgm.playSFX("ELARION -- The Final Vow.wav");
        }
