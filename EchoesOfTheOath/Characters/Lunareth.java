...
public class Lunareth extends Character {
    ...
    public Lunareth() {
        super("Lunareth", " VEYORA < NATION 2 > - MAIN BOSS", 1400, 6);
    ...
    public Sprite[] getSkillSprite(int skillNumber) {
        // Play the sound the exact millisecond the animation is requested!
        switch (skillNumber) {
            case 1 -> bgm.playSFX("LUNARETH moonpierce shot.wav");
            case 2 -> bgm.playSFX("LUNARETH Binding Roots_noisles.wav");
            case 3 -> bgm.playSFX("LUNARETH Eclipse Volley_noisles.wav");
        }
        // Then return the visual sprites normally
