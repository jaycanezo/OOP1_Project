...
public class GameOverPanel extends JPanel {
    ...
    public GameOverPanel(GameWindow game) {
        ...
        JLabel deathLabel = new JLabel("THE OATH IS BROKEN");
        deathLabel.setFont(new Font("Serif", Font.BOLD, 64));
        ...
        gbc.gridy = 0; gbc.insets = new Insets(0, 0, 50, 0); add(deathLabel, gbc);
        gbc.gridy = 1; gbc.insets = new Insets(10, 0, 10, 0); add(retryBtn, gbc);
