        ...
        while(true) {
            ...
            input = scan.nextLine();
                if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip"))
                    break;
            System.out.println("You land the final blow. Sarukdal falls to one knee. The dark energy cracks and shatters from his armor. The shadow recedes from his eyes, revealing the true guardian beneath.)");
            input = scan.nextLine();
                if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip"))
                    break;
            ...
            input = scan.nextLine();
                if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip"))
                    break;
            System.out.print("(Sarukdal dissolves into motes of dark and light. His greatshield clatters to the ground, now cleansed of corruption. Your final memory is restored.)");
            input = scan.nextLine();
                if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip"))
                    break;
            ...
            input = scan.nextLine();
                if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip"))
                    break;
            System.out.print("(The chamber behind Sarukdal opens, revealing a spiraling staircase of fractured light, ascending into pure darkness.)");
            input = scan.nextLine();
                if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip"))
                    break;
            ...
            for(int i=3; i>0; i--){
                ...
                while(true){
                    System.out.println("A chasm opens before you, bridged by three unstable platforms. One path is covered in shimmering Humanas glyphs; another is bathed in a fading Elven light; the third is a straight path unmarred by shadows.");
                    ...
                    if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip")) {
                        ...
                        System.out.println("The path disconnects from the ledge the moment step in. It wasn't broken; it was never attached.");
                        System.out.println("Elarion (Voice, distant): \"In this place, safety is the greatest lie.\"");
                        System.out.println("Restarting the quest...");
                        isSuccess = false;
                        break;
                    }else {
                        System.out.println("Unsure of your footing, you hesitate, and the chasm's instability pulls you down. You died.");
                        System.out.println("Restarting the quest...");
                        isSuccess = false;
                        break;
                    }
                ...
                while(true){
                    ...
                    if (input.equalsIgnoreCase("s") || input.equalsIgnoreCase("skip")) {
                        ...
                        System.out.print("The echoes recoil in disbelief, their accusations dissolving into wisps of smoke as they cannot latch onto your spirit.");
                        scan.nextLine();
                        System.out.print("\"He's using my own memories against me. The people I couldn't save.\"");
                        scan.nextLine();
                ...
                if(syncRoll < 6) {
                    ...
                    scan.nextLine();
                    System.out.println("(It is a vast, empty void. On a throne of fractured light sits ELARION. He appears as a shifting entity of pure shadow, but as you approach, he takes on a form — a perfect, mirror image of you, made of darkness.)");
                }
                scan.nextLine();
