...
public class Ending {
    ...
    public void endingScene(Character chosen){
        ...
        System.out.println("A blinding white light erupts, consuming the screen. The Umbral Fortress crumbles. The darkness over the land recedes.");
        scan.nextLine();




        System.out.println("(You are standing in a green field, identical to the one from your dream. The sun is rising. You look at your hands. Faint, glowing lines of energy—the mark of the restored Oath—are visible on your skin.)");
        scan.nextLine();
