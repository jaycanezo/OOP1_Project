...
public class MiniQuest3 {
    ...
    public void BrokenOathTrial() {
        ...
        while (restart) {
            ...
            if (tries == 0) { restart = gameOver(); continue; }

            // ------------------------- ROUND 2 -------------------------
            if (!round(
                    "ROUND 2 — The Moment of Failure",
                    "WHY DID HE BREAK?",
                    new String[]{"Because you failed first", "Because he was too weak", "Because the void chose him"},
                    'A',     // Correct: A
                    tries
            )) {
                tries--;
            ...
            if (!round(
                    ...
                    new String[]{"To destroy the enemy", "To endure what the others could not", "To replace the hero"},
                    'B',     // Correct: B
                    tries
            )) {
                tries--;
